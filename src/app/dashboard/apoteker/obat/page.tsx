...
export default function MasterObatPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["masterObat"] });
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2 text-slate-800">
            <PackageSearch className="text-klinik-blue" /> Manajemen Stok Obat
          </h1>
          <p className="text-sm text-slate-500">
            Kelola master data obat dan ketersediaan stok fisik klinik.
          </p>
        </div>
        <Button
          color="primary"
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="flex flex-col gap-4">
                ...
                <Input
                  label="Satuan"
                  placeholder="Contoh: Tablet / Sirup / Ampul"
